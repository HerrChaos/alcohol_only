package charten.alcoho_only.block;

import charten.alcoho_only.Alcoholonly;
import charten.alcoho_only.block.custom.*;
...
public class ModBlocks {
    ...
    public static final Block ALCOHOL_BARREL_BLOCK = registerBlock("alcohol_barrel_block",
            new Alcohol_barrel_block(AbstractBlock.Settings.create().pistonBehavior(PistonBehavior.NORMAL).sounds(BlockSoundGroup.WOOD).strength(2f)));
