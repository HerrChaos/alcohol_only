package charten.alcoholonly.block.custom;
...
public class AlcoholBottleBlock extends Block {
    ...
    private final VoxelShape ONE_BOTTLE_SHAPE;
    private final VoxelShape TWO_BOTTLE_SHAPE;
    private final VoxelShape THREE_BOTTLE_SHAPE;
    private final VoxelShape FOUR_BOTTLE_SHAPE;
    private final VoxelShape FIVE_BOTTLE_SHAPE;
    private final VoxelShape SIX_BOTTLE_SHAPE;

    public AlcoholBottleBlock(Settings settings, VoxelShape one, VoxelShape two, VoxelShape three, VoxelShape four, VoxelShape five, VoxelShape six) {
        super(settings);
        this.ONE_BOTTLE_SHAPE = one;
        this.TWO_BOTTLE_SHAPE = two;
        this.THREE_BOTTLE_SHAPE = three;
        this.FOUR_BOTTLE_SHAPE = four;
        this.FIVE_BOTTLE_SHAPE = five;
        this.SIX_BOTTLE_SHAPE = six;
