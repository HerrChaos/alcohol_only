...
import charten.alcoholonly.block.custom.blockentity.AlcoholBarrelBlockEntity;
...
public class AlcoholBarrelBlock extends BlockWithEntity implements BlockEntityProvider {
    ...
    public BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        ...
        return new AlcoholBarrelBlockEntity(pos, state);
    }
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        return validateTicker(type, ModBlockEntityTypes.ALCOHOL_BARREL_ENTITY, AlcoholBarrelBlockEntity::tick);
    }
    ...
    protected ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, BlockHitResult hit) {
        AlcoholBarrelBlockEntity.OnUse(state, world, pos, player, hit);
