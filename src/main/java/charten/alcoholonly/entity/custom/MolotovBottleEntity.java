package charten.alcoholonly.entity.custom;
...
public class MolotovBottleEntity extends ThrownItemEntity {
    public MolotovBottleEntity(EntityType<? extends ThrownItemEntity> entityType, World world) {
        super(ModEntities.MOLOTOV_BOTTLE_ENTITY, world);
    }
    public MolotovBottleEntity(LivingEntity livingEntity, World world) {
