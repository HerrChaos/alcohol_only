package charten.alcoholonly.Item.custom;
            ...
            if (items.contains(itemInHand)) {
                ...
                if (!world.isClient) {
                    ...
                    if (itemInHand == ModItems.VODKA) {
                        entity = new BottleEntity(ModEntities.VODKA_BOTTLE_PROJECTILE, user, world);
                    } else if (itemInHand == ModItems.BEER) {
                        entity = new BottleEntity(ModEntities.BEER_BOTTLE_PROJECTILE, user, world);
                    } else if (itemInHand == ModItems.WINE) {
                        entity = new BottleEntity(ModEntities.WINE_BOTTLE_PROJECTILE, user, world);
                    } else if (itemInHand == ModItems.JAEGERMEISTER) {
                        entity = new BottleEntity(ModEntities.JAEGERMEISTER_BOTTLE_PROJECTILE, user, world);
